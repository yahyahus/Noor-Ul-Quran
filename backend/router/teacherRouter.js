...
const { getStudentsForTeacher, assignStudentToTeacher,markAttendance,getMonthlyAttendance ,markSabaq,markSabqi,markManzil,getMonthlyProgress } = require('../controllers/teacherController'); // Import the functions

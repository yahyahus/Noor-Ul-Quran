...
import { Calendar, BookOpen, Book, BookMarked, Check, X } from "lucide-react";
...
function ProgressMarking() {
    ...
    const handleSabqiSubmit = async (studentId) => {
        try {
            setDateLoading(true);
            const response = await markSabqi(studentId, selectedDate, sabqi);
            setCompletionStatus(prevStatus => ({
                ...prevStatus,
                [studentId]: {
                    ...prevStatus[studentId],
    ...
    const handleManzilSubmit = async (studentId) => {
        try {
            setDateLoading(true);
            const response = await markManzil(studentId, selectedDate, manzil);
            setCompletionStatus(prevStatus => ({
                ...prevStatus,
                [studentId]: {
                    ...prevStatus[studentId],
                                                            ...
                                                            <div className="grid grid-cols-2 gap-4">
                                                                <div>
                                                                    ...
                                                                    <Input 
                                                                        type="text" 
                                                                        className="mt-1"
                                                                        onChange={(e) => setSabqi({ ...sabqi, juzz: e.target.value })}
                                                                    />
                                                                </div>
                                                                <div>
                                                                    <Label>Quality</Label>
                                                            ...
                                                            <div className="grid grid-cols-2 gap-4">
                                                                <div>
                                                                    ...
                                                                    <Input 
                                                                        type="text" 
                                                                        className="mt-1"
                                                                        onChange={(e) => setManzil({ ...manzil, juzz: e.target.value })}
                                                                    />
                                                                </div>
                                                                <div>
                                                                    <Label>Quality</Label>
